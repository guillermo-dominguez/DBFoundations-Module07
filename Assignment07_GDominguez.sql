...
-- 2017-01-01,GDominguez,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_GDominguez')
	 Begin 
	  Alter Database [Assignment07DB_GDominguez] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_GDominguez;
	 End
	Create Database Assignment07DB_GDominguez;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_GDominguez;
...
AS 
	...
	IIF(Month(InventoryDate)= 1, 0, Lag(i.Count) Over(Order By ProductName, i.InventoryDate)) AS PreviousMonthCount
	FROM vProducts AS p
